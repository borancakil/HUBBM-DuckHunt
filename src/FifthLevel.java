...
/**
 * Represents the fifth level of the game.
 */
public class FifthLevel {
    ...
    /**
     * Constructs the FifthLevel object.
     *
     * @param backgroundImageView the ImageView for the background
     */
    public FifthLevel(ImageView backgroundImageView, double SCALE, double VOLUME) {
        this.SCALE = SCALE;
        this.VOLUME = VOLUME;
        ...
        double width = backgroundImageView.getImage().getWidth() * FifthLevel.this.SCALE;
        double height = backgroundImageView.getImage().getHeight() * FifthLevel.this.SCALE;
        ...
        duck2.fly(2.0, -2.0, 100 * SCALE ,0 * SCALE, SCALE);
        duck1.fly(-2.0, 1.5, 0 * SCALE ,-20 * SCALE, SCALE);

    }

    /**
     * Displays the fifth level.
     *
    ...
    public void show(Stage stage, ImageView backgroundImageView, ImageView crossHairView, ImageView foregroundView, double SCALE) {
        ...
        crossHairImageView.setFitWidth(10*FifthLevel.this.SCALE);
        crossHairImageView.setFitHeight(10*FifthLevel.this.SCALE);

        // Creating our labels
        Label label1 = new Label("Level 5/6");
        label1.setFont(Font.font("Arial", 8*FifthLevel.this.SCALE));
        label1.setTextFill(Color.YELLOW);
        label1.setStyle("-fx-font-weight: bold;");

        Label label2 = new Label("Ammo Left: " + ammo);
        label2.setFont(Font.font("Arial", 8*FifthLevel.this.SCALE));
        ...
        scaledCrosshair.setFitWidth(crossHairView.getImage().getWidth() * FifthLevel.this.SCALE);
        scaledCrosshair.setFitHeight(crossHairView.getImage().getHeight() * FifthLevel.this.SCALE);
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (ammo == 0 && (ducks.size() != killedDucks.size())) {
                    ...
                    gameOverLabel.setFont(Font.font("Arial", 15 * FifthLevel.this.SCALE));
                    gameOverLabel.setTextFill(Color.YELLOW);
                    gameOverLabel.setStyle("-fx-font-weight: bold;");

                    gameOverLabel.setTranslateX(0.6 * FifthLevel.this.SCALE);
                    gameOverLabel.setTranslateY(-17.5 * FifthLevel.this.SCALE);

                    Label enter = new Label("Press ENTER to play again");
                    enter.setFont(Font.font("Arial", 15 * FifthLevel.this.SCALE));
                    enter.setTextFill(Color.YELLOW);
                    enter.setStyle("-fx-font-weight: bold;");

                    enter.setTranslateX(0.6 * FifthLevel.this.SCALE);
                    enter.setTranslateY(0);

                    Label escape = new Label("Press ESC to exit");
                    escape.setFont(Font.font("Arial", 15 * FifthLevel.this.SCALE));
                    escape.setTextFill(Color.YELLOW);
                    escape.setStyle("-fx-font-weight: bold;");

                    escape.setTranslateX(0.6 * FifthLevel.this.SCALE);
                    escape.setTranslateY(15 * FifthLevel.this.SCALE);
        ...
        AnimationTimer timer1 = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (killedDucks.size() == ducks.size()) {
                    ...
                    youWinLabel.setFont(Font.font("Arial", 15 * FifthLevel.this.SCALE));
                    youWinLabel.setTextFill(Color.YELLOW);
                    youWinLabel.setStyle("-fx-font-weight: bold;");

                    youWinLabel.setTranslateX(0.6 * FifthLevel.this.SCALE);
                    youWinLabel.setTranslateY(-17.5 * FifthLevel.this.SCALE);
        ...
        level1Scene.setOnKeyPressed(event -> {
            ...
            if (killedDucks.size() == ducks.size()) {
                ...
                if (event.getCode() == KeyCode.ENTER) {
                    mediaPlayer.stop();
                    FinalLevel finalLevel = new FinalLevel(backgroundImageView, SCALE, VOLUME
                    );
                    finalLevel.show(stage, backgroundImageView, crossHairView, foregroundView, SCALE);
                }
            }
        });

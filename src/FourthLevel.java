...
public class FourthLevel {
    ...
    double VOLUME;
    /**
     * Constructs the FourthLevel object.
     *
     * @param backgroundImageView the ImageView for the background
     */
    public FourthLevel(ImageView backgroundImageView, double SCALE, double VOLUME) {
        this.SCALE = SCALE;
        this.VOLUME = VOLUME;
        ...
        double width = backgroundImageView.getImage().getWidth() * FourthLevel.this.SCALE;
        double height = backgroundImageView.getImage().getHeight() * FourthLevel.this.SCALE;
        ...
        Duck duck2 = new Duck(145 * SCALE, -190*SCALE, flyImages2, shotDuckImageBlack, deadDuckImageBlack, width, height, SCALE, VOLUME);
        ducks.add(duck2);

        duck2.fly(2.0, 0.0, 0 * SCALE ,0 * SCALE, SCALE);
        duck1.fly(-1.0, 1.5, 0 * SCALE ,0 * SCALE, SCALE);
    ...
    public void show(Stage stage, ImageView backgroundImageView, ImageView crossHairView, ImageView foregroundView, double SCALE) {
        ...
        crossHairImageView.setFitWidth(10*FourthLevel.this.SCALE);
        crossHairImageView.setFitHeight(10*FourthLevel.this.SCALE);

        // Creating our labels
        Label label1 = new Label("Level 4/6");
        label1.setFont(Font.font("Arial", 8*FourthLevel.this.SCALE));
        label1.setTextFill(Color.YELLOW);
        label1.setStyle("-fx-font-weight: bold;");

        Label label2 = new Label("Ammo Left: " + ammo);
        label2.setFont(Font.font("Arial", 8*FourthLevel.this.SCALE));
        ...
        scaledCrosshair.setFitWidth(crossHairView.getImage().getWidth() * FourthLevel.this.SCALE);
        scaledCrosshair.setFitHeight(crossHairView.getImage().getHeight() * FourthLevel.this.SCALE);
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (ammo == 0 && (ducks.size() != killedDucks.size())) {
                    ...
                    gameOverLabel.setFont(Font.font("Arial", 15 * FourthLevel.this.SCALE));
                    gameOverLabel.setTextFill(Color.YELLOW);
                    gameOverLabel.setStyle("-fx-font-weight: bold;");

                    gameOverLabel.setTranslateX(0.6 * FourthLevel.this.SCALE);
                    gameOverLabel.setTranslateY(-17.5 * FourthLevel.this.SCALE);

                    Label enter = new Label("Press ENTER to play again");
                    enter.setFont(Font.font("Arial", 15 * FourthLevel.this.SCALE));
                    enter.setTextFill(Color.YELLOW);
                    enter.setStyle("-fx-font-weight: bold;");

                    enter.setTranslateX(0.6 * FourthLevel.this.SCALE);
                    enter.setTranslateY(0);

                    Label escape = new Label("Press ESC to exit");
                    escape.setFont(Font.font("Arial", 15 * FourthLevel.this.SCALE));
                    escape.setTextFill(Color.YELLOW);
                    escape.setStyle("-fx-font-weight: bold;");

                    escape.setTranslateX(0.6 * FourthLevel.this.SCALE);
                    escape.setTranslateY(15 * FourthLevel.this.SCALE);
        ...
        AnimationTimer timer1 = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (killedDucks.size() == ducks.size()) {
                    ...
                    youWinLabel.setFont(Font.font("Arial", 15 * FourthLevel.this.SCALE));
                    youWinLabel.setTextFill(Color.YELLOW);
                    youWinLabel.setStyle("-fx-font-weight: bold;");

                    youWinLabel.setTranslateX(0.6 * FourthLevel.this.SCALE);
                    youWinLabel.setTranslateY(-17.5 * FourthLevel.this.SCALE);
        ...
        level1Scene.setOnKeyPressed(event -> {
            ...
            if (killedDucks.size() == ducks.size()) {
                ...
                if (event.getCode() == KeyCode.ENTER) {
                    mediaPlayer.stop();
                    FifthLevel thirdLevel = new FifthLevel(backgroundImageView, SCALE, VOLUME);

...
public class ThirdLevel {
    ...
    /**
     * Constructs the ThirdLevel object.
     *
     * @param backgroundImageView the ImageView for the background
     */
    public ThirdLevel(ImageView backgroundImageView, double SCALE, double VOLUME) {
        this.SCALE = SCALE;
        this.VOLUME = VOLUME;
        ...
        double width = backgroundImageView.getImage().getWidth() * ThirdLevel.this.SCALE;
        double height = backgroundImageView.getImage().getHeight() * ThirdLevel.this.SCALE;
        ...
        Image deadDuckImageBlack = new Image("file:C:\\Users\\boran\\IdeaProjects\\duckhunt\\src\\assets\\duck_blue\\8.png");
        Image shotDuckImageBlack = new Image("file:C:\\Users\\boran\\IdeaProjects\\duckhunt\\src\\assets\\duck_blue\\7.png");
        Duck duck2 = new Duck(200 * SCALE, -150*SCALE, flyImages2, shotDuckImageBlack, deadDuckImageBlack, width, height, SCALE, VOLUME);
        ducks.add(duck2);

        duck2.fly(1.0, 2.0, 0 * SCALE ,0 * SCALE, SCALE);
    ...
    public void show(Stage stage, ImageView backgroundImageView, ImageView crossHairView, ImageView foregroundView, double SCALE) {
        ...
        crossHairImageView.setFitWidth(10*ThirdLevel.this.SCALE);
        crossHairImageView.setFitHeight(10*ThirdLevel.this.SCALE);

        // Creating our labels
        Label label1 = new Label("Level 3/6");
        label1.setFont(Font.font("Arial", 8*ThirdLevel.this.SCALE));
        label1.setTextFill(Color.YELLOW);
        label1.setStyle("-fx-font-weight: bold;");

        Label label2 = new Label("Ammo Left: " + ammo);
        label2.setFont(Font.font("Arial", 8*ThirdLevel.this.SCALE));
        ...
        scaledCrosshair.setFitWidth(crossHairView.getImage().getWidth() * ThirdLevel.this.SCALE);
        scaledCrosshair.setFitHeight(crossHairView.getImage().getHeight() * ThirdLevel.this.SCALE);
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (ammo == 0 && (ducks.size() != killedDucks.size())) {
                    ...
                    gameOverLabel.setFont(Font.font("Arial", 15 * ThirdLevel.this.SCALE));
                    gameOverLabel.setTextFill(Color.YELLOW);
                    gameOverLabel.setStyle("-fx-font-weight: bold;");

                    gameOverLabel.setTranslateX(0.6 * ThirdLevel.this.SCALE);
                    gameOverLabel.setTranslateY(-17.5 * ThirdLevel.this.SCALE);

                    Label enter = new Label("Press ENTER to play again");
                    enter.setFont(Font.font("Arial", 15 * ThirdLevel.this.SCALE));
                    enter.setTextFill(Color.YELLOW);
                    enter.setStyle("-fx-font-weight: bold;");

                    enter.setTranslateX(0.6 * ThirdLevel.this.SCALE);
                    enter.setTranslateY(0);

                    Label escape = new Label("Press ESC to exit");
                    escape.setFont(Font.font("Arial", 15 * ThirdLevel.this.SCALE));
                    escape.setTextFill(Color.YELLOW);
                    escape.setStyle("-fx-font-weight: bold;");

                    escape.setTranslateX(0.6 * ThirdLevel.this.SCALE);
                    escape.setTranslateY(15 * ThirdLevel.this.SCALE);
        ...
        AnimationTimer timer1 = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (killedDucks.size() == ducks.size()) {
                    ...
                    youWinLabel.setFont(Font.font("Arial", 15 * ThirdLevel.this.SCALE));
                    youWinLabel.setTextFill(Color.YELLOW);
                    youWinLabel.setStyle("-fx-font-weight: bold;");

                    youWinLabel.setTranslateX(0.6 * ThirdLevel.this.SCALE);
                    youWinLabel.setTranslateY(-17.5 * ThirdLevel.this.SCALE);
        ...
        level1Scene.setOnKeyPressed(event -> {
            ...
            if (killedDucks.size() == ducks.size()) {
                ...
                if (event.getCode() == KeyCode.ENTER) {
                    FourthLevel fourthLevel = new FourthLevel(backgroundImageView, SCALE, VOLUME
                    );
                    fourthLevel.show(stage, backgroundImageView, crossHairView, foregroundView, SCALE);
                }
            }
        });
